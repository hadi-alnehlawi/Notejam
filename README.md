...
```
* One we successfully build the docker image, we need to push it into any contianer registery, ex [docker hub](https://hub.docker.com), it will be used to build the deployment in the next step. 
